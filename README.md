Write a program that stores data about the products stored in an inventory, such as product ID, product name, price, quantity stored and the minimum quantity. The program should:
a. Add a new product.
